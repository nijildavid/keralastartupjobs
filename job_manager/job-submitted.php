...
switch ( $job->post_status ) :
	...
	break;
	case 'pending' :
		printf( __( '%s submitted successfully. Your job listing will be visible once approved. Please check after a while and if it is taking more than a day, send an email to support@keralastartupjobs.com', 'wp-job-manager' ), $wp_post_types['job_listing']->labels->singular_name, get_permalink( $job->ID ) );
	break;
	default :
