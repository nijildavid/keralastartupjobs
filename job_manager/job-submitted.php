...
switch ( $job->post_status ) :
	...
	break;
	case 'pending' :
		printf( __( '%s submitted successfully. Your job listing will be visible once approved.', 'wp-job-manager' ), $wp_post_types['job_listing']->labels->singular_name, get_permalink( $job->ID ) );
	break;
	default :
